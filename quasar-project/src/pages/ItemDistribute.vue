    ...
    <div>
      <div class="row no-wrap justify-around q-px-md q-pt-md">
        <div v-mutation="handler1" @dragenter="onDragEnter" @dragleave="onDragLeave" @dragover="onDragOver" @drop="onDrop"
          ...
          <div id="box1" draggable="true" @dragstart="onDragStart" class="box navy"></div>
          <div id="box2" draggable="true" @dragstart="onDragStart" class="box red"></div>
          <div id="box3" draggable="true" @dragstart="onDragStart" class="box green"></div>
          <div id="box4" draggable="true" @dragstart="onDragStart" class="box orange"></div>
          <div id="box5" draggable="true" @dragstart="onDragStart" class="box navy"></div>
          <div id="box6" draggable="true" @dragstart="onDragStart" class="box red"></div>
          <div id="box7" draggable="true" @dragstart="onDragStart" class="box green"></div>
          <div id="box8" draggable="true" @dragstart="onDragStart" class="box orange"></div>
        </div>

        <div v-mutation="handler2" @dragenter="onDragEnter" @dragleave="onDragLeave" @dragover="onDragOver" @drop="onDrop"
          class="drop-target rounded-borders overflow-hidden"></div>
      </div>
